---
id: how-to-custom-adapter
title: "Write a custom adapter"
sidebar_label: "Write a custom adapter"
---
...
continue [here](04_use-connect.md).
:::
...
-DarchetypeVersion=0.98.0 -DgroupId=org.apache.streampipes \
...
* `Line 13`: The event must finally be passed to the `collector`, which then takes the data and distributes it within
  StreamPipes in the form of a [data stream](03_concepts-terms.md#data-stream).
...
see [here](04_use-connect.md#schema-editor)),
