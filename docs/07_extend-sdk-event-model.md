...
This guide assumes that you are already familiar with the basic setup of [data processors](05_how-to-custom-data-processor.md).

### Property Selectors

In most cases, fields that are subject to be transformed by pipeline elements are provided by the assigned ``MappingProperty`` (see the guide on [static properties](07_extend-sdk-static-properties.md)).
...
Note: If you add a new field to an input event, you don't need to provide the selector, you can just assign the runtime name as defined by the [output strategy](07_extend-sdk-output-strategies.md).
