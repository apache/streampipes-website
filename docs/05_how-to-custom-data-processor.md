---
id: how-to-custom-data-processor
title: "Write a custom data processor"
sidebar_label: "Write a custom data processor"
---
...
-DarchetypeVersion=0.98.0 -DgroupId=my.groupId \
-DartifactId=my-example -DclassNamePrefix=MyExample -DpackageName=mypackagename
```

You will see a project structure similar to the structure shown in the [archetypes](07_extend-archetypes.md) section.
...
the [Processor SDK](07_extend-sdk-static-properties.md) for an overview). Similar to stream requirements, it is also recommended to type `Labels.withId("radius")` and move labels and descriptions to the resource file.
...
See the [event model](07_extend-sdk-event-model.md) guide to learn how to extract parameters from events.
...
the [user guide](06_configure-operate-extensions.md).
...
Follow our [SDK guide](07_extend-sdk-static-properties.md) to see what's possible!
