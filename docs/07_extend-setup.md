...
The documentation on the usage of the CLI tool is available [here](07_extend-cli.md).
...
Create the Maven archetype as described in the [Maven Archetypes](07_extend-archetypes.md) guide.
